...
# Initialize model
model = ResNetMultiClass(num_classes=num_classes)
...
if __name__ == "__main__":
    ...
    # Save model
    torch.save(model.state_dict(), 'resnet50_20_lr0001ep.pth')
    print("Model saved as resnet50_20_lr0001ep.pth")
    
    # Generate Confusion Matrix
    model.load_state_dict(torch.load('resnet50_30_lr00005ep.pth',weights_only=True))
    model.to(device)
    model.eval()
